...
public class MasterGroupTest {
	...
	public void testRealizarVentaGeneraMetadatosFactura() {
		...
		pedido.agregarProducto(new Producto(7, "Producto base", 15), 2);
    ...
    // Modifico este test ya que considero que no tiene sentido y es inconsistente
    // si miramos todos los demas test, por ejemplo el de abajo que nos dice
    // que un pedido solo digital no deberia generar gastos de envio
	...
	public void testCalcularEnvioSinProductosFisicos() {
		...
		pedido.agregarProducto(new Producto(1, "Licencia", 20), 1);
		pedido.agregarProducto(new ProductoDigital(2, "Curso", 30, 45), 2);

        //Modifico este test 
		assertEquals(0.0, pedido.calcularEnvio(cliente.getPais()),
				"Un pedido sin productos fisicos no deberia generar gastos de envio");
	}
	...
	public void testCalcularEnvioSoloDigitalDebeSerCero() {
		...
		pedido.agregarProducto(new ProductoDigital(10, "Curso", 30, 54), 2);
	...
	public void testRealizarVentaConPaisNuloFalla() {
		...
		pedido.agregarProducto(new ProductoFisico(11, "Libro", 20, 2), 1);
	...
	public void testRealizarVentaConPaisVacioFalla() {
		...
		pedido.agregarProducto(new ProductoFisico(12, "Libro", 20, 2), 1);
	...
	public void testRealizarVentaSoloFisicoSinIvaDigital() {
		...
		pedido.agregarProducto(new ProductoFisico(13, "Teclado", 50, 0.2), 2);
	...
	public void testRealizarVentaSoloProductosGenericosSinEnvioNiIva() {
		...
		pedido.agregarProducto(new Producto(14, "Pack", 12), 3);
	...
	public void testRealizarVentaSoloProductosGenericosEnPortugalSinEnvio() {
		...
		pedido.agregarProducto(new Producto(19, "Pack", 12), 3);
	...
	public void testPedidoDebePermitirCreacionConColeccionesIniciales() {
		...
		Producto productoDigital = new ProductoDigital(2, "Curso", 25, 32);
	...
	public void testPedidoCreadoConColeccionesDebeCalcularTotal() {
		...
		Producto productoDigital = new ProductoDigital(4, "Plantilla", 10, 154);
		...
		assertEquals(56.3, pedido.calcularTotal(),
	...
	public void testPedidoCreadoConColeccionesDebeFallarSiFaltaCantidad() {
		...
		Producto productoDigital = new ProductoDigital(6, "Suscripcion", 14, 987);
		List<Producto> productos = List.of(productoBase, productoDigital);
		Map<Integer, Integer> cantidades = new HashMap<>();
	...
	public void testPedidoNoDebeCompartirListaExterna() {
		...
		Producto producto2 = new ProductoDigital(22, "Curso", 10, 76);
	...
	public void testPedidoNoDebeCompartirMapaExterno() {
		...
		Producto producto2 = new ProductoDigital(24, "Plantilla", 6, 124);
	...
	public void testCalcularIvaConTiposAlternativos(String tipoIva, double ivaEsperado) {
		...
		pedido.agregarProducto(new ProductoDigital(1, "Suscripcion", 25, 43), 2);
		pedido.agregarProducto(new ProductoFisico(2, "Libro", 18, 1.5), 1);
	...
	public void testRealizarVentaMantieneLaIdentidadAritmetica() {
		...
		pedido.agregarProducto(new ProductoFisico(15, "Tablet", 100, 1), 1);
		pedido.agregarProducto(new ProductoDigital(16, "Licencia", 50, 3), 2);
	...
	public void testRealizarVentaGeneraCodigosDistintos() {
		...
		pedido1.agregarProducto(new Producto(17, "Producto A", 10), 1);
		pedido2.agregarProducto(new Producto(18, "Producto B", 10), 1);
	...
	public void testRealizarVentaConClienteDistintoAlPedidoFalla() {
		...
		pedido.agregarProducto(new ProductoFisico(20, "Tablet", 100, 2), 1);
